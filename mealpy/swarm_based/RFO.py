...
class OriginalRFO(Optimizer):
    """
    The original implementation of: Red Fox Optimization (RFO)

    Links:
        https://doi.org/10.1007/s10462-020-09904-6
    """
    ...
    def evolve(self, epoch):
        ...
        for idx in range(self.pop_size):
            ...
            dist = np.abs(self.g_best.solution - self.pop[idx].solution)
